...
const { jexlExpressionStringFromAst } = require('./serialize')
...
class Jexl {
  ...
  /**
   * Serializes an AST to the expression string.
   * @param {Object} ast The operator string to be removed
   */
  toString(ast) {
    return jexlExpressionStringFromAst(this._grammar, ast)
  }
