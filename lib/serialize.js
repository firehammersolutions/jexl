...
function jexlExpressionStringFromAst(grammar, ast) {
  if (!ast) {
    return ''
  }

  const recur = (ast) => jexlExpressionStringFromAst(grammar, ast)
...
module.exports = {
  jexlExpressionStringFromAst,
  escapeKeyOfExpressionIdentifier
}
